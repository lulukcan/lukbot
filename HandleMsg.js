	...
	// Filter Banned People
        ...
        case 'stiker':
            if ((isMedia || isQuotedImage) && args.length === 0) {
                ...
                aruga.reply(from, 'Gw minta tolong bgt kak, tlong difollow ig saya, bantu support bot ini dengn cara follow aja kak :) 👊🙁 https://www.instagram.com/bknsr mau difollowback DM saja')
                ...
                if (isMedia || isQuotedImage) {
                    ...
                    console.log(err)
	   	            await aruga.reply(from, 'Maaf batas penggunaan hari ini sudah mencapai maksimal ( Follow dulu instagram gw https://www.instagram.com/bknsr', id)
                    }
                }
        ...
        case 'stikergif':
            if (isMedia || isQuotedVideo) {
                if (mimetype === 'video/mp4' && message.duration < 10 || mimetype === 'image/gif' && message.duration < 10) {
                    var mediaData = await decryptMedia(message, uaOverride)
                    aruga.reply(from, '[WAIT] Sedang di proses⏳ silahkan tunggu ± 1 min! sambil (Follow dulu instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
        ...
        case 'stickergiphy':
            ...
            if (isGiphy) {
                ...
                .catch(() => {
                    aruga.reply(from, `Ada yang error! (Follow dulu instagram gw 👊🙁 https://www.instagram.com/bknsr)`, id)
                })
            } else {
        ...
        case 'meme':
            if ((isMedia || isQuotedImage) && args.length >= 2) {
                ...
                aruga.sendFile(from, ImageBase64, 'image.png', '', null, true)
                    .then(() => {
                        aruga.reply(from, 'Succes kak...(Support gw ya kak dengan cara Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)',id)
                    })
                    .catch(() => {
        ...
        case 'quotemaker':
            ...
            if (qmaker.length >= 3) {
                ...
                try {
                    ...
                    aruga.sendFileFromUrl(from, `${hasilqmaker}`, '', 'Succes kak...(Support gw ya kak dengan cara Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
                } catch {
        ...
        case 'nulis':
            ...
            await aruga.sendImage(from, `${nulisp}`, '', 'Succes kak... (Support gw ya kak dengan cara Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
            .catch(() => {
        ...
        case 'daerah':
            ...
            .catch(() => {
                aruga.reply(from, 'Ada yang Error! (Support gw ya kak dengan cara Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
            })
            break
        //Media
        case 'ytmp3':
        ...
        case 'ytmp4':
            ...
            case 'twimg':
            if (args.length == 0) return aruga.reply(from, `Untuk mendownload gambar dari twitter\nketik: ${prefix}twimg [link_twitter]`, id)
            const twimg = await rugaapi.twitimg(args[0])
            await aruga.sendFileFromUrl(from, twimg, 'Sukses mengunduh Foto Twitter Menggunakan Bot WhatsApp LACBOT', '', id)
            .catch(() => {
                aruga.reply(from, 'Ada yang Error!', id)
            })
        case 'twvid':
            if (args.length == 0) return aruga.reply(from, `Untuk mendownload video dari twitter\nketik: ${prefix}twvid [link_twitter]`, id)
            await aruga.reply(from, `_Tunggu, sedang memproses perintah_`, id)
            const twvid = await rugaapi.twitvid(args[0])
            await aruga.sendFileFromUrl(from, twvid, 'Sukses mengunduh Video Twitter Menggunakan Bot WhatsApp LACBOT', '', id)
            .catch(() => {
                aruga.reply(from, 'Ada yang Error!', id)
            })
        case 'insta':
        case 'ig':
            ...
            await aruga.sendFileFromUrl(from, instag, 'Sukses mengunduh Foto/Video Instagram Menggunakan Bot WhatsApp LukBoT', '', id)
            .catch(() => {
                aruga.reply(from, 'Ada yang Error!', id)
            })
            break
            ...
            await aruga.sendFileFromUrl(from, vidTiktok, '', '', id)
            await aruga.sendText(from, infoTiktok, '', '', id)
            .catch(() => {
                aruga.reply(from, 'Ada yang Error!', id)
            })
            break
		...
		case 'facebook':
			...
			.then(async (res) => {
				...
				await aruga.sendFileFromUrl(from, linkhd, '', 'Nih ngab videonya (Support gw ya kak dengan cara Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
				.catch(async () => {
					await aruga.sendFileFromUrl(from, linksd, '', 'Nih ngab videonya (Support gw ya kak dengan cara Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
					.catch(() => {
        ...
        case 'anime':
            ...
            if (args[0] == 'random' || args[0] == 'waifu' || args[0] == 'husbu' || args[0] == 'neko') {
                ...
                .then(body => {
                    ...
                    aruga.sendFileFromUrl(from, randomnimex, '', 'Succes kak...(Support gw ya kak dengan cara Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
                })
                .catch(() => {
                    aruga.reply(from, 'Ada yang Error! (Support gw ya kak dengan cara Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
                })
        ...
        case 'kpop':
            ...
            if (args[0] == 'blackpink' || args[0] == 'exo' || args[0] == 'bts') {
                ...
                .then(body => {
                    ...
                    aruga.sendFileFromUrl(from, randomkpopx, '', 'Success.. (Support gw ya kak dengan cara Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
                })
                .catch(() => {
                    aruga.reply(from, 'Ada yang Error!', id)
                })
        ...
        case 'resep':
            ...
            await aruga.reply(from, hasilresep + '\n\nIni kak resep makanannya.. (Support gw ya kak dengan cara Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
            .catch(() => {
                aruga.reply(from, 'Ada yang Error! (Support gw ya kak dengan cara Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
            })
            break
        ...
        case 'translate':
            ...
            translate(quoteText, args[0])
                ...
                .catch(() => aruga.sendText(from, 'Error, Kode bahasa salah. (Support gw ya kak dengan cara Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)'))
            break
		case 'covidindo':
			rugaapi.covidindo()
			.then(async (res) => {
